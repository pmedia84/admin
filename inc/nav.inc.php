<nav class="nav-bar">
    <div class="nav-container">
        ...
        <ul class="nav-links">
            ...
            <li ><a class="nav-link" href="">Photo Gallery <img src="assets/img/icons/image.svg" alt=""></a></li>
            ...
            <?php endif;?>
            <li ><a class="nav-link" href="">Support <img src="assets/img/icons/headset.svg" alt=""></a></li>
        </ul>
    </div>
</nav>