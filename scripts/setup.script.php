...
if (isset($_POST['action'])) {
    ...
    if ($_POST['action'] == "create_user") {
        ...
        $new_user = $db->prepare('INSERT INTO users (user_email, user_name, user_pw, user_type, user_pw_status, business_id)VALUES(?,?,?,?,?,?)');
        $new_user->bind_param('sssssi',$user_email, $user_name, $password, $user_type, $user_pw_status, $business_id);
        $new_user->execute();
        $new_user->close();
        echo $business_name;
