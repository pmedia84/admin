...
if (isset($_POST['news_articles_title'])) {
    ...
    $new_article = $db->prepare('INSERT INTO news_articles (news_articles_title, news_articles_body, news_articles_img, news_articles_author, news_articles_status)VALUES(?,?,?,?,?)');
    $new_article->bind_param('sssis', $news_articles_title, $news_articles_body, $news_articles_img, $user_id, $news_articles_status);
    $new_article->execute();
    $new_article->close();
